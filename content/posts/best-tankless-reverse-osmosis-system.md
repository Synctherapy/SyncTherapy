        ...
        <main class="space-y-12">
            ...
            <section id="frizzlife-600" class="product-card">
                ...
                <div class="grid md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <a href="https://amzn.to/4hLPEjy" target="_blank" class="affiliate-button w-full block text-center">Check Best Price on Amazon →</a>
                    </div>
                </div>
            </section>
            ...
            <section id="waterdrop-g3p600" class="product-card">
                ...
                <div class="grid md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <a href="https://amzn.to/4fp4evw" target="_blank" class="affiliate-button w-full block text-center">Get Best Price on Amazon →</a>
                    </div>
                </div>
            </section>
            ...
            <section id="ispring-ro500ak" class="product-card">
                ...
                <div class="grid md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <a href="https://amzn.to/4eoJTFn" target="_blank" class="affiliate-button w-full block text-center">Check Price on Amazon →</a>
                    </div>
                </div>
            </section>
            ...
            <section id="nu-aqua-800" class="product-card">
                ...
                <div class="grid md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <a href="https://amzn.to/4fJY8Ww" target="_blank" class="affiliate-button w-full block text-center">Check Price on Amazon →</a>
                    </div>
                </div>
            </section>
            ...
            <section id="echo-ro" class="product-card">
                ...
                <div class="grid md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <a href="https://echowater.com/discount/affiliate10/?redirect=%2Fproducts%2Fecho-ro-reverse-osmosis/&uid=132&oid=6&affid=408" target="_blank" class="affiliate-button w-full block text-center">Get 10% Off Echo RO (Already 25% Off) →</a>
                    </div>
                </div>
            </section>
            ...
            <section class="bg-gradient-to-r from-primary to-blue-700 text-white p-6 rounded-lg shadow-lg">
                ...
                <div class="grid md:grid-cols-3 gap-4 mt-6 mb-6">
                    <div class="bg-white text-gray-900 p-4 rounded-lg">
                        ...
                        <a href="https://amzn.to/4hLPEjy" class="affiliate-button text-sm py-2 px-3">Check Amazon Price →</a>
                    </div>
                    ...
                    <div class="bg-white text-gray-900 p-4 rounded-lg">
                        ...
                        <a href="https://amzn.to/4fp4evw" class="affiliate-button text-sm py-2 px-3">Check Amazon Price →</a>
                    </div>
                    ...
                    <div class="bg-white text-gray-900 p-4 rounded-lg">
                        ...
                        <a href="https://echowater.com/discount/affiliate10/?redirect=%2Fproducts%2Fecho-ro-reverse-osmosis/&uid=132&oid=6&affid=408" class="affiliate-button text-sm py-2 px-3">Get 10% Off →</a>
                    </div>
                </div>
            ...
            <section class="bg-gray-100 p-6 rounded-lg">
                ...
                <div class="grid md:grid-cols-2 gap-3 mt-4">
                    <a href="https://synctherapylocal.local/best-reverse-osmosis-ro-water-filter/" class="bg-white p-3 rounded-lg shadow hover:shadow-md transition-shadow border-l-4 border-primary">
                    ...
                    <a href="https://synctherapylocal.local/best-countertop-reverse-osmosis-system/" class="bg-white p-3 rounded-lg shadow hover:shadow-md transition-shadow border-l-4 border-primary">
