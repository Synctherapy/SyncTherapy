...
import { Phone, MapPin, Star, Award, Menu as MenuIcon, X } from "lucide-react";
...
export default function Header() {
    ...
    return (
        <>
                        ...
                        <Menu setActive={setActive}>
                            <MenuItem setActive={setActive} active={active} item="Services">
                                <div className="text-sm grid grid-cols-2 gap-10 p-4 min-w-[500px]">
                                    ...
                                    />
                                    <ProductItem
                                        title="Direct Billing & Rates"
                                        href="/direct-billing/"
                                        description="Insurance direct billing and transparent pricing."
                                    />
                                </div>
                            </MenuItem>
                            ...
                            <MenuItem setActive={setActive} active={active} item="Conditions">
                                <div className="flex flex-col space-y-4 text-sm min-w-[200px] p-4">
                                    ...
                                    <HoveredLink href="/conditions/neck-shoulder-pain/">Headaches & Neck Pain</HoveredLink>
                                    <HoveredLink href="/conditions/shoulder-pain/">Shoulder Pain</HoveredLink>
                                    <HoveredLink href="/conditions/sciatica-treatment/">Hip & Knee Pain</HoveredLink>
                                    <HoveredLink href="/conditions/chronic-pain/">Chronic Pain</HoveredLink>
                                </div>
                            </MenuItem>
                            ...
                            <MenuItem setActive={setActive} active={active} item="About">
                                <div className="flex flex-col space-y-4 text-sm min-w-[200px] p-4">
                                    ...
                                    <HoveredLink href="/contact/">Contact & Location</HoveredLink>
                                </div>
                            </MenuItem>
            ...
            {isMobileMenuOpen && (
                <div
                    className="fixed inset-0 z-50 bg-white dark:bg-zinc-950 lg:hidden flex flex-col pt-6 pb-10 px-6 overflow-y-auto animate-in fade-in slide-in-from-right-full duration-300 motion-reduce:animate-none"
                >
                    {/* Close Button */}
                        ...
                        <nav className="flex flex-col space-y-1">
                            ...
                            <div className="py-2">
                                ...
                                <div className="pl-4 flex flex-col space-y-2.5 text-muted-foreground text-sm font-medium border-l-2 border-border/50 ml-1">
                                    ...
                                    <Link href="/services/sports-massage/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">
                                        Sports Massage
                                    </Link>
                                    <Link href="/services/deep-tissue-massage/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">
                                        Deep Tissue Massage
                                    </Link>
                                    <Link href="/services/myofascial-release/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">
                                        Myofascial Release
                                    </Link>
                                    <Link href="/services/visceral-manipulation/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">
                                        Visceral Manipulation
                                    </Link>
                                    <Link href="/direct-billing/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">
                            ...
                            <div className="py-2">
                                ...
                                <div className="pl-4 flex flex-col space-y-2.5 text-muted-foreground text-sm font-medium border-l-2 border-border/50 ml-1">
                                    ...
                                    <Link href="/conditions/shoulder-pain/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">Shoulder Pain</Link>
                                    <Link href="/conditions/sciatica-treatment/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">Hip & Knee Pain</Link>
                                    <Link href="/conditions/chronic-pain/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-primary transition-colors block pl-3">Chronic Pain</Link>
                                </div>
                            </div>

                            <Link href="/about/" onClick={() => setIsMobileMenuOpen(false)} className="py-2 text-base font-bold text-foreground hover:text-primary transition-colors">
                                About
                            </Link>
                            <Link href="/our-team/daryl-stubbs/" onClick={() => setIsMobileMenuOpen(false)} className="py-2 text-base font-bold text-foreground hover:text-primary transition-colors">
                                Our Team
                            </Link>
                            <Link href="/contact/" onClick={() => setIsMobileMenuOpen(false)} className="py-2 text-base font-bold text-foreground hover:text-primary transition-colors">
                                Contact & Location
                            </Link>
