    ...
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-4 text-center">
        <h2 className="font-serif text-3xl md:text-4xl text-primary-foreground text-balance">
          Come See Me in Colwood
        </h2>
        
        <p className="mt-4 text-primary-foreground/90 max-w-xl mx-auto leading-relaxed">
          I'm at 328 Wale Road, right here in Colwood. Easy to find, easy to park. If you're in Langford, Victoria, or anywhere on the West Shore — I'm closer than you think.
        </p>
